...
namespace DataProject
{
    public class DbHelperForMySQL
    {
        ...
        public static string _connectionString = System.Configuration.ConfigurationManager.AppSettings["ConnectionString"];
        public DbHelperForMySQL()
        {
        }
        ...
        {
            return GetMaxID(FieldName, TableName, _connectionString);
        }
        ...
        {
            return Exists(strSql, _connectionString);
        }
        ...
        {
            return Exists(strSql, _connectionString, cmdParms);
        }
        /// <summary>
        ...
        {
            return ExecuteSql(SQLString, _connectionString);
        }
        /// <summary>
        /// 执行SQL语句，返回影响的记录数
        /// </summary>
        ...
        {
            return ExecuteSqlByTime(SQLString, Times, _connectionString);
        }
        ...
        {
            return ExecuteSqlTran(SQLStringList, _connectionString);
        }
        /// <summary>
        /// 执行多条SQL语句，实现数据库事务。
        /// </summary>
        ...
        {
            return ExecuteSqlGet(SQLString, content, _connectionString);
        }
        ...
        {
            return ExecuteSqlInsertImg(strSQL, fs, _connectionString);
        }
        ...
        {
            return GetSingle(SQLString, _connectionString);
        }
        ...
        {
            return GetSingle(SQLString, Times, _connectionString);
        }
        ...
        {
            return ExecuteReader(strSQL, _connectionString);
        }
        /// <summary>
        ...
        {
            return Query(SQLString, _connectionString);
        }
        ...
        {
            return Query(SQLString, Times, _connectionString);
        }
        ...
        {
            return ExecuteSql(SQLString, _connectionString, cmdParms);
        }
        /// <summary>
        /// 执行SQL语句，返回影响的记录数
        /// </summary>
        ...
        {
            ExecuteSqlTran(SQLStringList, _connectionString);
        }
        ...
        {
            ExecuteSqlTranWithIndentity(SQLStringList, _connectionString);
        }
        /// <summary>
        /// 执行多条SQL语句，实现数据库事务。
        /// </summary>
        ...
        {
            return GetSingle(SQLString, _connectionString, cmdParms);
        }
        ...
        {
            return ExecuteReader(SQLString, _connectionString, cmdParms);
        }
        ...
        public static DataSet Query(string SQLString, params MySqlParameter[] cmdParms)
        {
            ...
            return Query(SQLString, _connectionString, cmdParms);
        }
